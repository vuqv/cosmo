...
cgModel = hps.models.buildHPSModel(pdb_file, hps_scale='urry')
...
simulation.reporters.append(
    StateDataReporter(f'{protein_code}_{stage}_30fs.log', logperiod, step=True, time=True, potentialEnergy=True, kineticEnergy=True,
                          totalEnergy=True, temperature=True, progress=True, remainingTime=True, speed=True,
                          totalSteps=mdsteps, separator='\t'))
