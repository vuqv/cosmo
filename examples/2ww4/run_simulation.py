...
def main():
    ...
    print(f'Setting hydropathy scale to: {model}') #modify this, not setting hydropathy, since mpipi and ed model do not use hydropathy parameter.
    ...
    if model in ['hps_kr', 'hps_urry', 'hps_ss', 'ed']:
