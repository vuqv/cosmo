# Tutorial 11 — Continuous Synthesis through an analytic tunnel (`cosmo-cylinder`)
...
[Tutorial 2](../02_models_and_forcefields/), and the analytic-tunnel idea introduced
in [Tutorial 9](../09_translation_cylinder/) (this is its `cosmo.csp` successor).
...
coarse-grained ribosome** mode is [Tutorial 12](../12_csp_ribosome/).
