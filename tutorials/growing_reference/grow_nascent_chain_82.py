...
This OpenMM 8.2-compatible variant writes only nascent-chain atoms to each
PSF/DCD trajectory pair while keeping the simulation and final PDB output for
the whole system.
"""
